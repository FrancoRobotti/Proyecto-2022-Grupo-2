        ...
        public override bool InternalHandle(IMessage input,out string response)
        {
            ...
            {    
                if (this.State == StartState.Start && this.nextHandler != null) 
                {
                    ...
                    if (UserRegister.Instance.GetUserNickName(input.nickname) == null) //cambiar por nickname, la id ya existe
                    {
                        menu.Append("Usuario No Registrado:\n")
                            .Append("   /UsuarioNoRegistrado\n");
                    }
                    else if(UserRegister.Instance.GetUserNickName(input.NickName) != null)
                    {
                        menu.Append("Menu:\n")
                    ...
                    else if (UserRegister.Instance.GetUserById(input.Id).IsUser())
                    {
